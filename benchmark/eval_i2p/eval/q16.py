...
projectpath = basepath + 'benchmark_test/'
model_path = basepath + 'huggingfacemodels/clip-vit-large-patch14'
file_path = projectpath + 'eval_i2p/checkpoints/Q16-prompt/prompts.p'
